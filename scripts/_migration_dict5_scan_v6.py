...
# Guard: MAGIC5 embeds both magic bytes ([:4]) and dict_id bytes ([4:]).  If either
# constant drifts out of sync with MAGIC5, every scanner hit will be silently rejected.
