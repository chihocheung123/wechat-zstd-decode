...
if [[ "${MODE}" == "developer" ]]; then
    echo "┌─────────────────────────────────────────────────────────┐"
    echo "│  DEVELOPER MODE — steps before running this script      │"
    echo "│                                                          │"
    echo "│  1. Connect iPhone via USB                               │"
    echo "│  2. Trust computer on device                             │"
    echo "│  3. In a SEPARATE terminal:                              │"
    echo "│       idevicedebugserverproxy ${PORT}                       │"
    echo "│  4. On iPhone: open WeChat, go to                        │"
    echo "│       Me → Settings → Chat → Backup & Migrate Chat       │"
    echo "│       History → start migration TO this Mac              │"
